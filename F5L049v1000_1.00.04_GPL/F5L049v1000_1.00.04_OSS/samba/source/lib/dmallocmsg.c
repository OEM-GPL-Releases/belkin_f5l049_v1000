				 ...
				 void *private_data)
{
	...
	DEBUG2(("Got MSG_REQ_DMALLOC_MARK: mark set\n"));
#else
	DEBUG2(("Got MSG_REQ_DMALLOC_MARK but dmalloc not in this process\n"));
#endif
}
					...
					void *private_data)
{
	...
	DEBUG2(("Got MSG_REQ_DMALLOC_LOG_CHANGED: done\n"));
#else
	DEBUG2(("Got MSG_REQ_DMALLOC_LOG_CHANGED but dmalloc not in this process\n"));
#endif
}
...
void register_dmalloc_msgs(void)
{
	...
	DEBUG2( ("Registered MSG_REQ_DMALLOC_MARK and LOG_CHANGED\n"));
}	
