...
static BOOL api_srv_net_share_enum_all(pipes_struct *p)
{
	...
	if(!srv_io_q_net_share_enum("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_enum_all: Failed to unmarshall SRV_Q_NET_SHARE_ENUM.\n"));
		return False;
	}
	...
	if (!srv_io_r_net_share_enum("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_enum_all: Failed to marshall SRV_R_NET_SHARE_ENUM.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_enum(pipes_struct *p)
{
	...
	/* Unmarshall the net server get enum. */
	if(!srv_io_q_net_share_enum("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_enum: Failed to unmarshall SRV_Q_NET_SHARE_ENUM.\n"));
		return False;
	}
	...
	if (!srv_io_r_net_share_enum("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_enum: Failed to marshall SRV_R_NET_SHARE_ENUM.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_get_info(pipes_struct *p)
{
	...
	if(!srv_io_q_net_share_get_info("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_get_info: Failed to unmarshall SRV_Q_NET_SHARE_GET_INFO.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_share_get_info("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_get_info: Failed to marshall SRV_R_NET_SHARE_GET_INFO.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_set_info(pipes_struct *p)
{
	...
	if(!srv_io_q_net_share_set_info("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_set_info: Failed to unmarshall SRV_Q_NET_SHARE_SET_INFO.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_share_set_info("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_set_info: Failed to marshall SRV_R_NET_SHARE_SET_INFO.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_add(pipes_struct *p)
{
	...
	if(!srv_io_q_net_share_add("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_add: Failed to unmarshall SRV_Q_NET_SHARE_ADD.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_share_add("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_add: Failed to marshall SRV_R_NET_SHARE_ADD.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_del(pipes_struct *p)
{
	...
	if(!srv_io_q_net_share_del("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_del: Failed to unmarshall SRV_Q_NET_SHARE_DEL.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_share_del("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_del: Failed to marshall SRV_R_NET_SHARE_DEL.\n"));
		return False;
	}
...
static BOOL api_srv_net_share_del_sticky(pipes_struct *p)
{
	...
	/* Unmarshall the net server del info. */
	if(!srv_io_q_net_share_del("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_share_del_sticky: Failed to unmarshall SRV_Q_NET_SHARE_DEL.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_share_del("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_share_del_sticky: Failed to marshall SRV_R_NET_SHARE_DEL.\n"));
		return False;
	}
...
static BOOL api_srv_net_disk_enum(pipes_struct *p) 
{
	...
	if(!srv_io_q_net_disk_enum("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_disk_enum: Failed to unmarshall SRV_Q_NET_DISK_ENUM.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_disk_enum("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_disk_enum: Failed to marshall SRV_R_NET_DISK_ENUM.\n"));
		return False;
	}
...
static BOOL api_srv_net_name_validate(pipes_struct *p) 
{
	...
	if(!srv_io_q_net_name_validate("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_name_validate: Failed to unmarshall SRV_Q_NET_NAME_VALIDATE.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_name_validate("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_name_validate: Failed to marshall SRV_R_NET_NAME_VALIDATE.\n"));
		return False;
	}
...
static BOOL api_srv_net_file_query_secdesc(pipes_struct *p)
{
	...
	if(!srv_io_q_net_file_query_secdesc("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_file_query_secdesc: Failed to unmarshall SRV_Q_NET_FILE_QUERY_SECDESC.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_file_query_secdesc("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_file_query_secdesc: Failed to marshall SRV_R_NET_FILE_QUERY_SECDESC.\n"));
		return False;
	}
...
static BOOL api_srv_net_file_set_secdesc(pipes_struct *p)
{
	...
	if(!srv_io_q_net_file_set_secdesc("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_file_set_secdesc: Failed to unmarshall SRV_Q_NET_FILE_SET_SECDESC.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_file_set_secdesc("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_file_set_secdesc: Failed to marshall SRV_R_NET_FILE_SET_SECDESC.\n"));
		return False;
	}
...
static BOOL api_srv_net_file_close(pipes_struct *p)
{
	...
	if(!srv_io_q_net_file_close("", &q_u, data, 0)) {
		DEBUG0(("api_srv_net_file_close: Failed to unmarshall SRV_Q_NET_FILE_SET_SECDESC.\n"));
		return False;
	}
	...
	if(!srv_io_r_net_file_close("", &r_u, rdata, 0)) {
		DEBUG0(("api_srv_net_file_close: Failed to marshall SRV_R_NET_FILE_SET_SECDESC.\n"));
		return False;
	}
