...
static BOOL api_eventlog_open_eventlog(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_open_eventlog("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_open_eventlog: unable to unmarshall EVENTLOG_Q_OPEN_EVENTLOG.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_open_eventlog("", &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_r_open_eventlog: unable to marshall EVENTLOG_R_OPEN_EVENTLOG.\n"));
		return False;
	}
...
static BOOL api_eventlog_close_eventlog(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_close_eventlog("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_close_eventlog: unable to unmarshall EVENTLOG_Q_CLOSE_EVENTLOG.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_close_eventlog("", &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_r_close_eventlog: unable to marshall EVENTLOG_R_CLOSE_EVENTLOG.\n"));
		return False;
	}
...
static BOOL api_eventlog_get_num_records(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_get_num_records("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_get_num_records: unable to unmarshall EVENTLOG_Q_GET_NUM_RECORDS.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_get_num_records("", &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_r_get_num_records: unable to marshall EVENTLOG_R_GET_NUM_RECORDS.\n"));
		return False;
	}
...
static BOOL api_eventlog_get_oldest_entry(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_get_oldest_entry("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_get_oldest_entry: unable to unmarshall EVENTLOG_Q_GET_OLDEST_ENTRY.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_get_oldest_entry("", &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_r_get_oldest_entry: unable to marshall EVENTLOG_R_GET_OLDEST_ENTRY.\n"));
		return False;
	}
...
static BOOL api_eventlog_read_eventlog(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_read_eventlog("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_read_eventlog: unable to unmarshall EVENTLOG_Q_READ_EVENTLOG.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_read_eventlog("", &q_u, &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_r_read_eventlog: unable to marshall EVENTLOG_R_READ_EVENTLOG.\n"));
		return False;
	}
...
static BOOL api_eventlog_clear_eventlog(pipes_struct *p)
{
	...
	if (!(eventlog_io_q_clear_eventlog("", &q_u, data, 0))) {
		DEBUG0( ("eventlog_io_q_clear_eventlog: unable to unmarshall EVENTLOG_Q_CLEAR_EVENTLOG.\n"));
		return False;
	}
	...
	if (!(eventlog_io_r_clear_eventlog("", &r_u, rdata, 0))) {
		DEBUG0( ("eventlog_io_q_clear_eventlog: unable to marshall EVENTLOG_Q_CLEAR_EVENTLOG.\n"));
		return False;
	}
