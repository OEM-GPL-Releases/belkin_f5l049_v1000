...
static BOOL api_net_req_chal(pipes_struct *p)
{
	...
	if(!net_io_q_req_chal("", &q_u, data, 0)) {
		DEBUG0(("api_net_req_chal: Failed to unmarshall NET_Q_REQ_CHAL.\n"));
		return False;
	}
	...
	if(!net_io_r_req_chal("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_req_chal: Failed to marshall NET_R_REQ_CHAL.\n"));
		return False;
	}
...
static BOOL api_net_auth(pipes_struct *p)
{
	...
	if(!net_io_q_auth("", &q_u, data, 0)) {
		DEBUG0(("api_net_auth: Failed to unmarshall NET_Q_AUTH.\n"));
		return False;
	}
	...
	if(!net_io_r_auth("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_auth: Failed to marshall NET_R_AUTH.\n"));
		return False;
	}
...
static BOOL api_net_auth_2(pipes_struct *p)
{
	...
	if(!net_io_q_auth_2("", &q_u, data, 0)) {
		DEBUG0(("api_net_auth_2: Failed to unmarshall NET_Q_AUTH_2.\n"));
		return False;
	}
	...
	if(!net_io_r_auth_2("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_auth_2: Failed to marshall NET_R_AUTH_2.\n"));
		return False;
	}
...
static BOOL api_net_srv_pwset(pipes_struct *p)
{
	...
	if(!net_io_q_srv_pwset("", &q_u, data, 0)) {
		DEBUG0(("api_net_srv_pwset: Failed to unmarshall NET_Q_SRV_PWSET.\n"));
		return False;
	}
	...
	if(!net_io_r_srv_pwset("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_srv_pwset: Failed to marshall NET_R_SRV_PWSET.\n"));
		return False;
	}
...
static BOOL api_net_sam_logoff(pipes_struct *p)
{
	...
	if(!net_io_q_sam_logoff("", &q_u, data, 0)) {
		DEBUG0(("api_net_sam_logoff: Failed to unmarshall NET_Q_SAM_LOGOFF.\n"));
		return False;
	}
	...
	if(!net_io_r_sam_logoff("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_sam_logoff: Failed to marshall NET_R_SAM_LOGOFF.\n"));
		return False;
	}
...
static BOOL api_net_sam_logon(pipes_struct *p)
{
	...
	if(!net_io_q_sam_logon("", &q_u, data, 0)) {
		DEBUG0( ("api_net_sam_logon: Failed to unmarshall NET_Q_SAM_LOGON.\n"));
		return False;
	}
	...
	if(!net_io_r_sam_logon("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_sam_logon: Failed to marshall NET_R_SAM_LOGON.\n"));
		return False;
	}
...
static BOOL api_net_trust_dom_list(pipes_struct *p)
{
	...
	if(!net_io_q_trust_dom("", &q_u, data, 0)) {
		DEBUG0(("api_net_trust_dom_list: Failed to unmarshall NET_Q_TRUST_DOM_LIST.\n"));
		return False;
	}
	...
	if(!net_io_r_trust_dom("", &r_u, rdata, 0)) {
		DEBUG0(("net_reply_trust_dom_list: Failed to marshall NET_R_TRUST_DOM_LIST.\n"));
		return False;
	}
...
static BOOL api_net_logon_ctrl2(pipes_struct *p)
{
	...
	if(!net_io_q_logon_ctrl2("", &q_u, data, 0)) {
		DEBUG0(("api_net_logon_ctrl2: Failed to unmarshall NET_Q_LOGON_CTRL2.\n"));
		return False;
	}
	...
	if(!net_io_r_logon_ctrl2("", &r_u, rdata, 0)) {
		DEBUG0(("net_reply_logon_ctrl2: Failed to marshall NET_R_LOGON_CTRL2.\n"));
		return False;
	}
...
static BOOL api_net_logon_ctrl(pipes_struct *p)
{
	...
	if(!net_io_q_logon_ctrl("", &q_u, data, 0)) {
		DEBUG0(("api_net_logon_ctrl: Failed to unmarshall NET_Q_LOGON_CTRL.\n"));
		return False;
	}
	...
	if(!net_io_r_logon_ctrl("", &r_u, rdata, 0)) {
		DEBUG0(("net_reply_logon_ctrl2: Failed to marshall NET_R_LOGON_CTRL.\n"));
		return False;
	}
...
static BOOL api_net_sam_logon_ex(pipes_struct *p)
{
	...
	if(!net_io_q_sam_logon_ex("", &q_u, data, 0)) {
		DEBUG0( ("api_net_sam_logon_ex: Failed to unmarshall NET_Q_SAM_LOGON_EX.\n"));
		return False;
	}
	...
	if(!net_io_r_sam_logon_ex("", &r_u, rdata, 0)) {
		DEBUG0(("api_net_sam_logon_ex: Failed to marshall NET_R_SAM_LOGON_EX.\n"));
		return False;
	}
...
static BOOL api_ds_enum_dom_trusts(pipes_struct *p)
{
	...
	DEBUG6(("api_ds_enum_dom_trusts\n"));

	if ( !ds_io_q_enum_domain_trusts("", data, 0, &q_u) ) {
		DEBUG0(("api_ds_enum_domain_trusts: Failed to unmarshall DS_Q_ENUM_DOM_TRUSTS.\n"));
		return False;
	}
	...
	if ( !ds_io_r_enum_domain_trusts("", rdata, 0, &r_u) ) {
		DEBUG0(("api_ds_enum_domain_trusts: Failed to marshall DS_R_ENUM_DOM_TRUSTS.\n"));
		return False;
	}
