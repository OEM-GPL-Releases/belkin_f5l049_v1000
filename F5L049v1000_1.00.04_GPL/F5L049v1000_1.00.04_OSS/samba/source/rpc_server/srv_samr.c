...
static BOOL api_samr_close_hnd(pipes_struct *p)
{
	...
	if(!samr_io_q_close_hnd("", &q_u, data, 0)) {
		DEBUG0(("api_samr_close_hnd: unable to unmarshall SAMR_Q_CLOSE_HND.\n"));
		return False;
	}
	...
	if(!samr_io_r_close_hnd("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_close_hnd: unable to marshall SAMR_R_CLOSE_HND.\n"));
		return False;
	}
...
static BOOL api_samr_open_domain(pipes_struct *p)
{
	...
	if(!samr_io_q_open_domain("", &q_u, data, 0)) {
		DEBUG0(("api_samr_open_domain: unable to unmarshall SAMR_Q_OPEN_DOMAIN.\n"));
		return False;
	}
	...
	if(!samr_io_r_open_domain("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_open_domain: unable to marshall SAMR_R_OPEN_DOMAIN.\n"));
		return False;
	}
...
static BOOL api_samr_get_usrdom_pwinfo(pipes_struct *p)
{
	...
	if(!samr_io_q_get_usrdom_pwinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_get_usrdom_pwinfo: unable to unmarshall SAMR_Q_GET_USRDOM_PWINFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_get_usrdom_pwinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_get_usrdom_pwinfo: unable to marshall SAMR_R_GET_USRDOM_PWINFO.\n"));
		return False;
	}
...
static BOOL api_samr_set_sec_obj(pipes_struct *p)
{
	...
	if(!samr_io_q_set_sec_obj("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_sec_obj: unable to unmarshall SAMR_Q_SET_SEC_OBJ.\n"));
		return False;
	}
	...
	if(!samr_io_r_set_sec_obj("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_sec_obj: unable to marshall SAMR_R_SET_SEC_OBJ.\n"));
		return False;
	}
...
static BOOL api_samr_query_sec_obj(pipes_struct *p)
{
	...
	if(!samr_io_q_query_sec_obj("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_sec_obj: unable to unmarshall SAMR_Q_QUERY_SEC_OBJ.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_sec_obj("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_sec_obj: unable to marshall SAMR_R_QUERY_SEC_OBJ.\n"));
		return False;
	}
...
static BOOL api_samr_enum_dom_users(pipes_struct *p)
{
	...
	if(!samr_io_q_enum_dom_users("", &q_u, data, 0)) {
		DEBUG0(("api_samr_enum_dom_users: unable to unmarshall SAMR_Q_ENUM_DOM_USERS.\n"));
		return False;
	}
	...
	if(!samr_io_r_enum_dom_users("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_enum_dom_users: unable to marshall SAMR_R_ENUM_DOM_USERS.\n"));
		return False;
	}
...
static BOOL api_samr_enum_dom_groups(pipes_struct *p)
{
	...
	if(!samr_io_q_enum_dom_groups("", &q_u, data, 0)) {
		DEBUG0(("api_samr_enum_dom_groups: unable to unmarshall SAMR_Q_ENUM_DOM_GROUPS.\n"));
		return False;
	}
	...
	if(!samr_io_r_enum_dom_groups("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_enum_dom_groups: unable to marshall SAMR_R_ENUM_DOM_GROUPS.\n"));
		return False;
	}
...
static BOOL api_samr_enum_dom_aliases(pipes_struct *p)
{
	...
	if(!samr_io_q_enum_dom_aliases("", &q_u, data, 0)) {
		DEBUG0(("api_samr_enum_dom_aliases: unable to unmarshall SAMR_Q_ENUM_DOM_ALIASES.\n"));
		return False;
	}
	...
	if(!samr_io_r_enum_dom_aliases("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_enum_dom_aliases: unable to marshall SAMR_R_ENUM_DOM_ALIASES.\n"));
		return False;
	}
...
static BOOL api_samr_query_dispinfo(pipes_struct *p)
{
	...
	if(!samr_io_q_query_dispinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_dispinfo: unable to unmarshall SAMR_Q_QUERY_DISPINFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_dispinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_dispinfo: unable to marshall SAMR_R_QUERY_DISPINFO.\n"));
		return False;
	}
...
static BOOL api_samr_query_aliasinfo(pipes_struct *p)
{
	...
	if(!samr_io_q_query_aliasinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_aliasinfo: unable to unmarshall SAMR_Q_QUERY_ALIASINFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_aliasinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_aliasinfo: unable to marshall SAMR_R_QUERY_ALIASINFO.\n"));
		return False;
	}
...
static BOOL api_samr_lookup_names(pipes_struct *p)
{
	...
	if(!samr_io_q_lookup_names("", &q_u, data, 0)) {
		DEBUG0(("api_samr_lookup_names: unable to unmarshall SAMR_Q_LOOKUP_NAMES.\n"));
		return False;
	}
	...
	if(!samr_io_r_lookup_names("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_lookup_names: unable to marshall SAMR_R_LOOKUP_NAMES.\n"));
		return False;
	}
...
static BOOL api_samr_chgpasswd_user(pipes_struct *p)
{
	...
	if (!samr_io_q_chgpasswd_user("", &q_u, data, 0)) {
		DEBUG0(("api_samr_chgpasswd_user: Failed to unmarshall SAMR_Q_CHGPASSWD_USER.\n"));
		return False;
	}
	...
	if(!samr_io_r_chgpasswd_user("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_chgpasswd_user: Failed to marshall SAMR_R_CHGPASSWD_USER.\n" ));
		return False;
	}
...
static BOOL api_samr_lookup_rids(pipes_struct *p)
{
	...
	if(!samr_io_q_lookup_rids("", &q_u, data, 0)) {
		DEBUG0(("api_samr_lookup_rids: unable to unmarshall SAMR_Q_LOOKUP_RIDS.\n"));
		return False;
	}
	...
	if(!samr_io_r_lookup_rids("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_lookup_rids: unable to marshall SAMR_R_LOOKUP_RIDS.\n"));
		return False;
	}
...
static BOOL api_samr_open_user(pipes_struct *p)
{
	...
	if(!samr_io_q_open_user("", &q_u, data, 0)) {
		DEBUG0(("api_samr_open_user: unable to unmarshall SAMR_Q_OPEN_USER.\n"));
		return False;
	}
	...
	if(!samr_io_r_open_user("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_open_user: unable to marshall SAMR_R_OPEN_USER.\n"));
		return False;
	}
...
static BOOL api_samr_query_userinfo(pipes_struct *p)
{
	...
	if(!samr_io_q_query_userinfo("", &q_u, data, 0)){
		DEBUG0(("api_samr_query_userinfo: unable to unmarshall SAMR_Q_QUERY_USERINFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_userinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_userinfo: unable to marshall SAMR_R_QUERY_USERINFO.\n"));
		return False;
	}
...
static BOOL api_samr_query_usergroups(pipes_struct *p)
{
	...
	if(!samr_io_q_query_usergroups("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_usergroups: unable to unmarshall SAMR_Q_QUERY_USERGROUPS.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_usergroups("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_usergroups: unable to marshall SAMR_R_QUERY_USERGROUPS.\n"));
		return False;
	}
...
static BOOL api_samr_query_domain_info(pipes_struct *p)
{
	...
	if(!samr_io_q_query_domain_info("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_domain_info: unable to unmarshall SAMR_Q_QUERY_DOMAIN_INFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_domain_info("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_domain_info: unable to marshall SAMR_R_QUERY_DOMAIN_INFO.\n"));
		return False;
	}
...
static BOOL api_samr_create_user(pipes_struct *p)
{
	...
	if (!samr_io_q_create_user("", &q_u, data, 0)) {
		DEBUG0(("api_samr_create_user: Unable to unmarshall SAMR_Q_CREATE_USER.\n"));
		return False;
	}
	...
	if(!samr_io_r_create_user("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_create_user: Unable to marshall SAMR_R_CREATE_USER.\n"));
		return False;
	}
...
static BOOL api_samr_connect_anon(pipes_struct *p)
{
	...
	if(!samr_io_q_connect_anon("", &q_u, data, 0)) {
		DEBUG0(("api_samr_connect_anon: unable to unmarshall SAMR_Q_CONNECT_ANON.\n"));
		return False;
	}
	...
	if(!samr_io_r_connect_anon("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_connect_anon: unable to marshall SAMR_R_CONNECT_ANON.\n"));
		return False;
	}
...
static BOOL api_samr_connect(pipes_struct *p)
{
	...
	if(!samr_io_q_connect("", &q_u, data, 0)) {
		DEBUG0(("api_samr_connect: unable to unmarshall SAMR_Q_CONNECT.\n"));
		return False;
	}
	...
	if(!samr_io_r_connect("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_connect: unable to marshall SAMR_R_CONNECT.\n"));
		return False;
	}
...
static BOOL api_samr_connect4(pipes_struct *p)
{
	...
	if(!samr_io_q_connect4("", &q_u, data, 0)) {
		DEBUG0(("api_samr_connect4: unable to unmarshall SAMR_Q_CONNECT4.\n"));
		return False;
	}
	...
	if(!samr_io_r_connect4("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_connect4: unable to marshall SAMR_R_CONNECT4.\n"));
		return False;
	}
...
static BOOL api_samr_chgpasswd_user3(pipes_struct *p)
{
	...
	if (!samr_io_q_chgpasswd_user3("", &q_u, data, 0)) {
		DEBUG0(("api_samr_chgpasswd_user3: Failed to unmarshall SAMR_Q_CHGPASSWD_USER3.\n"));
		return False;
	}
	...
	if(!samr_io_r_chgpasswd_user3("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_chgpasswd_user3: Failed to marshall SAMR_R_CHGPASSWD_USER3.\n" ));
		return False;
	}
...
static BOOL api_samr_connect5(pipes_struct *p)
{
	...
	if(!samr_io_q_connect5("", &q_u, data, 0)) {
		DEBUG0(("api_samr_connect5: unable to unmarshall SAMR_Q_CONNECT5.\n"));
		return False;
	}
	...
	if(!samr_io_r_connect5("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_connect5: unable to marshall SAMR_R_CONNECT5.\n"));
		return False;
	}
...
static BOOL api_samr_lookup_domain(pipes_struct *p)
{
	...
	if(!samr_io_q_lookup_domain("", &q_u, data, 0)) {
		DEBUG0(("api_samr_lookup_domain: Unable to unmarshall SAMR_Q_LOOKUP_DOMAIN.\n"));
		return False;
	}
	...
	if(!samr_io_r_lookup_domain("", &r_u, rdata, 0)){
		DEBUG0(("api_samr_lookup_domain: Unable to marshall SAMR_R_LOOKUP_DOMAIN.\n"));
		return False;
	}
...
static BOOL api_samr_enum_domains(pipes_struct *p)
{
	...
	if(!samr_io_q_enum_domains("", &q_u, data, 0)) {
		DEBUG0(("api_samr_enum_domains: Unable to unmarshall SAMR_Q_ENUM_DOMAINS.\n"));
		return False;
	}
	...
	if(!samr_io_r_enum_domains("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_enum_domains: Unable to marshall SAMR_R_ENUM_DOMAINS.\n"));
		return False;
	}
...
static BOOL api_samr_open_alias(pipes_struct *p)
{
	...
	if(!samr_io_q_open_alias("", &q_u, data, 0)) {
		DEBUG0(("api_samr_open_alias: Unable to unmarshall SAMR_Q_OPEN_ALIAS.\n"));
		return False;
	}
	...
	if(!samr_io_r_open_alias("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_open_alias: Unable to marshall SAMR_R_OPEN_ALIAS.\n"));
		return False;
	}
...
static BOOL api_samr_set_userinfo(pipes_struct *p)
{
	...
	if (!samr_io_q_set_userinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_userinfo: Unable to unmarshall SAMR_Q_SET_USERINFO.\n"));
		/* Fix for W2K SP2 */
	...
	if(!samr_io_r_set_userinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_userinfo: Unable to marshall SAMR_R_SET_USERINFO.\n"));
		return False;
	}
...
static BOOL api_samr_set_userinfo2(pipes_struct *p)
{
	...
	if (!samr_io_q_set_userinfo2("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_userinfo2: Unable to unmarshall SAMR_Q_SET_USERINFO2.\n"));
		return False;
	}
	...
	if(!samr_io_r_set_userinfo2("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_userinfo2: Unable to marshall SAMR_R_SET_USERINFO2.\n"));
		return False;
	}
...
static BOOL api_samr_query_useraliases(pipes_struct *p)
{
	...
	if (!samr_io_q_query_useraliases("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_useraliases:  Unable to unmarshall SAMR_Q_QUERY_USERALIASES.\n"));
		return False;
	}
	...
	if (! samr_io_r_query_useraliases("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_useraliases:  Unable to nmarshall SAMR_R_QUERY_USERALIASES.\n"));
		return False;
	}
...
static BOOL api_samr_query_aliasmem(pipes_struct *p)
{
	...
	if (!samr_io_q_query_aliasmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_aliasmem: unable to unmarshall SAMR_Q_QUERY_ALIASMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_query_aliasmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_aliasmem: unable to marshall SAMR_R_QUERY_ALIASMEM.\n"));
		return False;
	}
...
static BOOL api_samr_query_groupmem(pipes_struct *p)
{
	...
	if (!samr_io_q_query_groupmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_groupmem: unable to unmarshall SAMR_Q_QUERY_GROUPMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_query_groupmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_groupmem: unable to marshall SAMR_R_QUERY_GROUPMEM.\n"));
		return False;
	}
...
static BOOL api_samr_add_aliasmem(pipes_struct *p)
{
	...
	if (!samr_io_q_add_aliasmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_add_aliasmem: unable to unmarshall SAMR_Q_ADD_ALIASMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_add_aliasmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_add_aliasmem: unable to marshall SAMR_R_ADD_ALIASMEM.\n"));
		return False;
	}
...
static BOOL api_samr_del_aliasmem(pipes_struct *p)
{
	...
	if (!samr_io_q_del_aliasmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_del_aliasmem: unable to unmarshall SAMR_Q_DEL_ALIASMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_del_aliasmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_del_aliasmem: unable to marshall SAMR_R_DEL_ALIASMEM.\n"));
		return False;
	}
...
static BOOL api_samr_add_groupmem(pipes_struct *p)
{
	...
	if (!samr_io_q_add_groupmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_add_groupmem: unable to unmarshall SAMR_Q_ADD_GROUPMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_add_groupmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_add_groupmem: unable to marshall SAMR_R_ADD_GROUPMEM.\n"));
		return False;
	}
...
static BOOL api_samr_del_groupmem(pipes_struct *p)
{
	...
	if (!samr_io_q_del_groupmem("", &q_u, data, 0)) {
		DEBUG0(("api_samr_del_groupmem: unable to unmarshall SAMR_Q_DEL_GROUPMEM.\n"));
		return False;
	}
	...
	if (!samr_io_r_del_groupmem("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_del_groupmem: unable to marshall SAMR_R_DEL_GROUPMEM.\n"));
		return False;
	}
...
static BOOL api_samr_delete_dom_user(pipes_struct *p)
{
	...
	if (!samr_io_q_delete_dom_user("", &q_u, data, 0)) {
		DEBUG0(("api_samr_delete_dom_user: unable to unmarshall SAMR_Q_DELETE_DOM_USER.\n"));
		return False;
	}
	...
	if (!samr_io_r_delete_dom_user("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_delete_dom_user: unable to marshall SAMR_R_DELETE_DOM_USER.\n"));
		return False;
	}
...
static BOOL api_samr_delete_dom_group(pipes_struct *p)
{
	...
	if (!samr_io_q_delete_dom_group("", &q_u, data, 0)) {
		DEBUG0(("api_samr_delete_dom_group: unable to unmarshall SAMR_Q_DELETE_DOM_GROUP.\n"));
		return False;
	}
	...
	if (!samr_io_r_delete_dom_group("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_delete_dom_group: unable to marshall SAMR_R_DELETE_DOM_GROUP.\n"));
		return False;
	}
...
static BOOL api_samr_delete_dom_alias(pipes_struct *p)
{
	...
	if (!samr_io_q_delete_dom_alias("", &q_u, data, 0)) {
		DEBUG0(("api_samr_delete_dom_alias: unable to unmarshall SAMR_Q_DELETE_DOM_ALIAS.\n"));
		return False;
	}
	...
	if (!samr_io_r_delete_dom_alias("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_delete_dom_alias: unable to marshall SAMR_R_DELETE_DOM_ALIAS.\n"));
		return False;
	}
...
static BOOL api_samr_create_dom_group(pipes_struct *p)
{
	...
	if (!samr_io_q_create_dom_group("", &q_u, data, 0)) {
		DEBUG0(("api_samr_create_dom_group: unable to unmarshall SAMR_Q_CREATE_DOM_GROUP.\n"));
		return False;
	}
	...
	if (!samr_io_r_create_dom_group("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_create_dom_group: unable to marshall SAMR_R_CREATE_DOM_GROUP.\n"));
		return False;
	}
...
static BOOL api_samr_create_dom_alias(pipes_struct *p)
{
	...
	if (!samr_io_q_create_dom_alias("", &q_u, data, 0)) {
		DEBUG0(("api_samr_create_dom_alias: unable to unmarshall SAMR_Q_CREATE_DOM_ALIAS.\n"));
		return False;
	}
	...
	if (!samr_io_r_create_dom_alias("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_create_dom_alias: unable to marshall SAMR_R_CREATE_DOM_ALIAS.\n"));
		return False;
	}
...
static BOOL api_samr_query_groupinfo(pipes_struct *p)
{
	...
	if (!samr_io_q_query_groupinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_groupinfo: unable to unmarshall SAMR_Q_QUERY_GROUPINFO.\n"));
		return False;
	}
	...
	if (!samr_io_r_query_groupinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_groupinfo: unable to marshall SAMR_R_QUERY_GROUPINFO.\n"));
		return False;
	}
...
static BOOL api_samr_set_groupinfo(pipes_struct *p)
{
	...
	if (!samr_io_q_set_groupinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_groupinfo: unable to unmarshall SAMR_Q_SET_GROUPINFO.\n"));
		return False;
	}
	...
	if (!samr_io_r_set_groupinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_groupinfo: unable to marshall SAMR_R_SET_GROUPINFO.\n"));
		return False;
	}
...
static BOOL api_samr_set_aliasinfo(pipes_struct *p)
{
	...
	if (!samr_io_q_set_aliasinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_aliasinfo: unable to unmarshall SAMR_Q_SET_ALIASINFO.\n"));
		return False;
	}
	...
	if (!samr_io_r_set_aliasinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_aliasinfo: unable to marshall SAMR_R_SET_ALIASINFO.\n"));
		return False;
	}
...
static BOOL api_samr_get_dom_pwinfo(pipes_struct *p)
{
	...
	if (!samr_io_q_get_dom_pwinfo("", &q_u, data, 0)) {
		DEBUG0(("api_samr_get_dom_pwinfo: unable to unmarshall SAMR_Q_GET_DOM_PWINFO.\n"));
		return False;
	}
	...
	if (!samr_io_r_get_dom_pwinfo("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_get_dom_pwinfo: unable to marshall SAMR_R_GET_DOM_PWINFO.\n"));
		return False;
	}
...
static BOOL api_samr_open_group(pipes_struct *p)
{
	...
	if (!samr_io_q_open_group("", &q_u, data, 0)) {
		DEBUG0(("api_samr_open_group: unable to unmarshall SAMR_Q_OPEN_GROUP.\n"));
		return False;
	}
	...
	if (!samr_io_r_open_group("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_open_group: unable to marshall SAMR_R_OPEN_GROUP.\n"));
		return False;
	}
...
static BOOL api_samr_remove_sid_foreign_domain(pipes_struct *p)
{
	...
	if (!samr_io_q_remove_sid_foreign_domain("", &q_u, data, 0)) {
		DEBUG0(("api_samr_remove_sid_foreign_domain: unable to unmarshall SAMR_Q_REMOVE_SID_FOREIGN_DOMAIN.\n"));
		return False;
	}
	...
	if (!samr_io_r_remove_sid_foreign_domain("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_remove_sid_foreign_domain: unable to marshall SAMR_R_REMOVE_SID_FOREIGN_DOMAIN.\n"));
		return False;
	}
...
static BOOL api_samr_query_domain_info2(pipes_struct *p)
{
	...
	if(!samr_io_q_query_domain_info2("", &q_u, data, 0)) {
		DEBUG0(("api_samr_query_domain_info2: unable to unmarshall SAMR_Q_QUERY_DOMAIN_INFO2.\n"));
		return False;
	}
	...
	if(!samr_io_r_query_domain_info2("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_query_domain_info2: unable to marshall SAMR_R_QUERY_DOMAIN_INFO2.\n"));
		return False;
	}
...
static BOOL api_samr_set_dom_info(pipes_struct *p)
{
	...
	if(!samr_io_q_set_domain_info("", &q_u, data, 0)) {
		DEBUG0(("api_samr_set_dom_info: unable to unmarshall SAMR_Q_SET_DOMAIN_INFO.\n"));
		return False;
	}
	...
	if(!samr_io_r_set_domain_info("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_set_dom_info: unable to marshall SAMR_R_SET_DOMAIN_INFO.\n"));
		return False;
	}
...
static BOOL api_samr_get_dispenum_index(pipes_struct *p)
{
	...
	if(!samr_io_q_get_dispenum_index("", &q_u, data, 0)) {
		DEBUG0(("api_samr_get_dispenum_index: unable to unmarshall SAMR_Q_GET_DISPENUM_INDEX.\n"));
		return False;
	}
	...
	if(!samr_io_r_get_dispenum_index("", &r_u, rdata, 0)) {
		DEBUG0(("api_samr_get_dispenum_index: unable to marshall SAMR_R_GET_DISPENUM_INDEX.\n"));
		return False;
	}
