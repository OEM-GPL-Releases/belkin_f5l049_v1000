...
static BOOL api_spoolss_open_printer(pipes_struct *p)
{
	...
	if (!spoolss_io_q_open_printer("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_open_printer: unable to unmarshall SPOOL_Q_OPEN_PRINTER.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_open_printer("",&r_u,rdata,0)){
		DEBUG0(("spoolss_io_r_open_printer: unable to marshall SPOOL_R_OPEN_PRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_open_printer_ex(pipes_struct *p)
{
	...
	if (!spoolss_io_q_open_printer_ex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_open_printer_ex: unable to unmarshall SPOOL_Q_OPEN_PRINTER_EX.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_open_printer_ex("",&r_u,rdata,0)){
		DEBUG0(("spoolss_io_r_open_printer_ex: unable to marshall SPOOL_R_OPEN_PRINTER_EX.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprinterdata(pipes_struct *p)
{
	...
	if (!spoolss_io_q_getprinterdata("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprinterdata: unable to unmarshall SPOOL_Q_GETPRINTERDATA.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_getprinterdata("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_getprinterdata: unable to marshall SPOOL_R_GETPRINTERDATA.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinterdata(pipes_struct *p)
{
	...
	if (!spoolss_io_q_deleteprinterdata("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinterdata: unable to unmarshall SPOOL_Q_DELETEPRINTERDATA.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_deleteprinterdata("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_deleteprinterdata: unable to marshall SPOOL_R_DELETEPRINTERDATA.\n"));
		return False;
	}
...
static BOOL api_spoolss_closeprinter(pipes_struct *p)
{
	...
	if (!spoolss_io_q_closeprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_closeprinter: unable to unmarshall SPOOL_Q_CLOSEPRINTER.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_closeprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_closeprinter: unable to marshall SPOOL_R_CLOSEPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_abortprinter(pipes_struct *p)
{
	...
	if (!spoolss_io_q_abortprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_abortprinter: unable to unmarshall SPOOL_Q_ABORTPRINTER.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_abortprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_abortprinter: unable to marshall SPOOL_R_ABORTPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinter(pipes_struct *p)
{
	...
	if (!spoolss_io_q_deleteprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinter: unable to unmarshall SPOOL_Q_DELETEPRINTER.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_deleteprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_deleteprinter: unable to marshall SPOOL_R_DELETEPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinterdriver(pipes_struct *p)
{
	...
	if (!spoolss_io_q_deleteprinterdriver("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinterdriver: unable to unmarshall SPOOL_Q_DELETEPRINTERDRIVER.\n"));
		return False;
	}
...
static BOOL api_spoolss_rffpcnex(pipes_struct *p)
{
	...
	if (!spoolss_io_q_rffpcnex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_rffpcnex: unable to unmarshall SPOOL_Q_RFFPCNEX.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_rffpcnex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_rffpcnex: unable to marshall SPOOL_R_RFFPCNEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_rfnpcnex(pipes_struct *p)
{
	...
	if (!spoolss_io_q_rfnpcnex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_rfnpcnex: unable to unmarshall SPOOL_Q_RFNPCNEX.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_rfnpcnex("", &r_u, rdata, 0)) {
		...
		DEBUG0(("spoolss_io_r_rfnpcnex: unable to marshall SPOOL_R_RFNPCNEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprinters(pipes_struct *p)
{
	...
	if (!spoolss_io_q_enumprinters("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprinters: unable to unmarshall SPOOL_Q_ENUMPRINTERS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumprinters("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprinters: unable to marshall SPOOL_R_ENUMPRINTERS.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_getprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprinter: unable to unmarshall SPOOL_Q_GETPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_getprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_getprinter: unable to marshall SPOOL_R_GETPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprinterdriver2(pipes_struct *p)
{
	...
	if(!spoolss_io_q_getprinterdriver2("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprinterdriver2: unable to unmarshall SPOOL_Q_GETPRINTERDRIVER2.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_getprinterdriver2("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_getprinterdriver2: unable to marshall SPOOL_R_GETPRINTERDRIVER2.\n"));
		return False;
	}
...
static BOOL api_spoolss_startpageprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_startpageprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_startpageprinter: unable to unmarshall SPOOL_Q_STARTPAGEPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_startpageprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_startpageprinter: unable to marshall SPOOL_R_STARTPAGEPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_endpageprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_endpageprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_endpageprinter: unable to unmarshall SPOOL_Q_ENDPAGEPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_endpageprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_endpageprinter: unable to marshall SPOOL_R_ENDPAGEPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_startdocprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_startdocprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_startdocprinter: unable to unmarshall SPOOL_Q_STARTDOCPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_startdocprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_startdocprinter: unable to marshall SPOOL_R_STARTDOCPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_enddocprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enddocprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enddocprinter: unable to unmarshall SPOOL_Q_ENDDOCPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enddocprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_enddocprinter: unable to marshall SPOOL_R_ENDDOCPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_writeprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_writeprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_writeprinter: unable to unmarshall SPOOL_Q_WRITEPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_writeprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_writeprinter: unable to marshall SPOOL_R_WRITEPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_setprinter(pipes_struct *p)
{
	...
	if(!spoolss_io_q_setprinter("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setprinter: unable to unmarshall SPOOL_Q_SETPRINTER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_setprinter("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_setprinter: unable to marshall SPOOL_R_SETPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_fcpn(pipes_struct *p)
{
	...
	if(!spoolss_io_q_fcpn("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_fcpn: unable to unmarshall SPOOL_Q_FCPN.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_fcpn("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_fcpn: unable to marshall SPOOL_R_FCPN.\n"));
		return False;
	}
...
static BOOL api_spoolss_addjob(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addjob("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_addjob: unable to unmarshall SPOOL_Q_ADDJOB.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addjob("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_addjob: unable to marshall SPOOL_R_ADDJOB.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumjobs(pipes_struct *p)
{
	...
	if (!spoolss_io_q_enumjobs("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumjobs: unable to unmarshall SPOOL_Q_ENUMJOBS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumjobs("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_enumjobs: unable to marshall SPOOL_R_ENUMJOBS.\n"));
		return False;
	}
...
static BOOL api_spoolss_schedulejob(pipes_struct *p)
{
	...
	if(!spoolss_io_q_schedulejob("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_schedulejob: unable to unmarshall SPOOL_Q_SCHEDULEJOB.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_schedulejob("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_schedulejob: unable to marshall SPOOL_R_SCHEDULEJOB.\n"));
		return False;
	}
...
static BOOL api_spoolss_setjob(pipes_struct *p)
{
	...
	if(!spoolss_io_q_setjob("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setjob: unable to unmarshall SPOOL_Q_SETJOB.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_setjob("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_setjob: unable to marshall SPOOL_R_SETJOB.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprinterdrivers(pipes_struct *p)
{
	...
	if (!spoolss_io_q_enumprinterdrivers("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprinterdrivers: unable to unmarshall SPOOL_Q_ENUMPRINTERDRIVERS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumprinterdrivers("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_enumprinterdrivers: unable to marshall SPOOL_R_ENUMPRINTERDRIVERS.\n"));
		return False;
	}
...
static BOOL api_spoolss_getform(pipes_struct *p)
{
	...
	if (!spoolss_io_q_getform("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getform: unable to unmarshall SPOOL_Q_GETFORM.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_getform("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_getform: unable to marshall SPOOL_R_GETFORM.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumforms(pipes_struct *p)
{
	...
	if (!spoolss_io_q_enumforms("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumforms: unable to unmarshall SPOOL_Q_ENUMFORMS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumforms("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_enumforms: unable to marshall SPOOL_R_ENUMFORMS.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumports(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumports("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumports: unable to unmarshall SPOOL_Q_ENUMPORTS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumports("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_enumports: unable to marshall SPOOL_R_ENUMPORTS.\n"));
		return False;
	}
...
static BOOL api_spoolss_addprinterex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addprinterex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_addprinterex: unable to unmarshall SPOOL_Q_ADDPRINTEREX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addprinterex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_addprinterex: unable to marshall SPOOL_R_ADDPRINTEREX.\n"));
		return False;
	}
...
static BOOL api_spoolss_addprinterdriver(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addprinterdriver("", &q_u, data, 0)) {
		if (q_u.level != 3 && q_u.level != 6) {
			 ...
			 */
			DEBUG3(("api_spoolss_addprinterdriver: unknown SPOOL_Q_ADDPRINTERDRIVER level %u.\n",
				(unsigned int)q_u.level ));
			setup_fault_pdu(p, NT_STATUS(DCERPC_FAULT_INVALID_TAG));
			return True;
		}
		DEBUG0(("spoolss_io_q_addprinterdriver: unable to unmarshall SPOOL_Q_ADDPRINTERDRIVER.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addprinterdriver("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_addprinterdriver: unable to marshall SPOOL_R_ADDPRINTERDRIVER.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprinterdriverdirectory(pipes_struct *p)
{
	...
	if(!spoolss_io_q_getprinterdriverdir("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprinterdriverdir: unable to unmarshall SPOOL_Q_GETPRINTERDRIVERDIR.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_getprinterdriverdir("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_getprinterdriverdir: unable to marshall SPOOL_R_GETPRINTERDRIVERDIR.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprinterdata(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumprinterdata("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprinterdata: unable to unmarshall SPOOL_Q_ENUMPRINTERDATA.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enumprinterdata("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprinterdata: unable to marshall SPOOL_R_ENUMPRINTERDATA.\n"));
		return False;
	}
...
static BOOL api_spoolss_setprinterdata(pipes_struct *p)
{
	...
	if(!spoolss_io_q_setprinterdata("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setprinterdata: unable to unmarshall SPOOL_Q_SETPRINTERDATA.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_setprinterdata("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_setprinterdata: unable to marshall SPOOL_R_SETPRINTERDATA.\n"));
		return False;
	}
...
static BOOL api_spoolss_reset_printer(pipes_struct *p)
{
	...
	if(!spoolss_io_r_resetprinter("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_setprinterdata: unable to marshall SPOOL_R_RESETPRINTER.\n"));
		return False;
	}
...
static BOOL api_spoolss_addform(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addform("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_addform: unable to unmarshall SPOOL_Q_ADDFORM.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addform("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_addform: unable to marshall SPOOL_R_ADDFORM.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteform(pipes_struct *p)
{
	...
	if(!spoolss_io_q_deleteform("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteform: unable to unmarshall SPOOL_Q_DELETEFORM.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_deleteform("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_deleteform: unable to marshall SPOOL_R_DELETEFORM.\n"));
		return False;
	}
...
static BOOL api_spoolss_setform(pipes_struct *p)
{
	...
	if(!spoolss_io_q_setform("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setform: unable to unmarshall SPOOL_Q_SETFORM.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_setform("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_setform: unable to marshall SPOOL_R_SETFORM.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprintprocessors(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumprintprocessors("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprintprocessors: unable to unmarshall SPOOL_Q_ENUMPRINTPROCESSORS.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enumprintprocessors("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprintprocessors: unable to marshall SPOOL_R_ENUMPRINTPROCESSORS.\n"));
		return False;
	}
...
static BOOL api_spoolss_addprintprocessor(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addprintprocessor("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_addprintprocessor: unable to unmarshall SPOOL_Q_ADDPRINTPROCESSOR.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addprintprocessor("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_addprintprocessor: unable to marshall SPOOL_R_ADDPRINTPROCESSOR.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprintprocdatatypes(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumprintprocdatatypes("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprintprocdatatypes: unable to unmarshall SPOOL_Q_ENUMPRINTPROCDATATYPES.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enumprintprocdatatypes("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprintprocdatatypes: unable to marshall SPOOL_R_ENUMPRINTPROCDATATYPES.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprintmonitors(pipes_struct *p)
{
	...
	if (!spoolss_io_q_enumprintmonitors("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprintmonitors: unable to unmarshall SPOOL_Q_ENUMPRINTMONITORS.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_enumprintmonitors("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprintmonitors: unable to marshall SPOOL_R_ENUMPRINTMONITORS.\n"));
		return False;
	}
...
static BOOL api_spoolss_getjob(pipes_struct *p)
{
	...
	if(!spoolss_io_q_getjob("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getjob: unable to unmarshall SPOOL_Q_GETJOB.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_getjob("",&r_u,rdata,0)) {
		DEBUG0(("spoolss_io_r_getjob: unable to marshall SPOOL_R_GETJOB.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprinterdataex(pipes_struct *p)
{
	...
	if (!spoolss_io_q_getprinterdataex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprinterdataex: unable to unmarshall SPOOL_Q_GETPRINTERDATAEX.\n"));
		return False;
	}
	...
	if (!spoolss_io_r_getprinterdataex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_getprinterdataex: unable to marshall SPOOL_R_GETPRINTERDATAEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_setprinterdataex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_setprinterdataex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setprinterdataex: unable to unmarshall SPOOL_Q_SETPRINTERDATAEX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_setprinterdataex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_setprinterdataex: unable to marshall SPOOL_R_SETPRINTERDATAEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprinterkey(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumprinterkey("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_setprinterkey: unable to unmarshall SPOOL_Q_ENUMPRINTERKEY.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enumprinterkey("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprinterkey: unable to marshall SPOOL_R_ENUMPRINTERKEY.\n"));
		return False;
	}
...
static BOOL api_spoolss_enumprinterdataex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_enumprinterdataex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_enumprinterdataex: unable to unmarshall SPOOL_Q_ENUMPRINTERDATAEX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_enumprinterdataex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_enumprinterdataex: unable to marshall SPOOL_R_ENUMPRINTERDATAEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_getprintprocessordirectory(pipes_struct *p)
{
	...
	if(!spoolss_io_q_getprintprocessordirectory("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_getprintprocessordirectory: unable to unmarshall SPOOL_Q_GETPRINTPROCESSORDIRECTORY.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_getprintprocessordirectory("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_getprintprocessordirectory: unable to marshall SPOOL_R_GETPRINTPROCESSORDIRECTORY.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinterdataex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_deleteprinterdataex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinterdataex: unable to unmarshall SPOOL_Q_DELETEPRINTERDATAEX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_deleteprinterdataex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_deleteprinterdataex: unable to marshall SPOOL_R_DELETEPRINTERDATAEX.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinterkey(pipes_struct *p)
{
	...
	if(!spoolss_io_q_deleteprinterkey("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinterkey: unable to unmarshall SPOOL_Q_DELETEPRINTERKEY.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_deleteprinterkey("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_deleteprinterkey: unable to marshall SPOOL_R_DELETEPRINTERKEY.\n"));
		return False;
	}
...
static BOOL api_spoolss_addprinterdriverex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_addprinterdriverex("", &q_u, data, 0)) {
		if (q_u.level != 3 && q_u.level != 6) {
			 ...
			 * to allow downgrade from level 8 (Vista).
			 */
			DEBUG3(("api_spoolss_addprinterdriverex: unknown SPOOL_Q_ADDPRINTERDRIVEREX level %u.\n",
				(unsigned int)q_u.level ));
			setup_fault_pdu(p, NT_STATUS(DCERPC_FAULT_INVALID_TAG));
			return True;
		}
		DEBUG0(("spoolss_io_q_addprinterdriverex: unable to unmarshall SPOOL_Q_ADDPRINTERDRIVEREX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_addprinterdriverex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_addprinterdriverex: unable to marshall SPOOL_R_ADDPRINTERDRIVEREX.\n"));
		return False;
	}
...
static BOOL api_spoolss_deleteprinterdriverex(pipes_struct *p)
{
	...
	if(!spoolss_io_q_deleteprinterdriverex("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_deleteprinterdriverex: unable to unmarshall SPOOL_Q_DELETEPRINTERDRIVEREX.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_deleteprinterdriverex("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_deleteprinterdriverex: unable to marshall SPOOL_R_DELETEPRINTERDRIVEREX.\n"));
		return False;
	}
...
static BOOL api_spoolss_xcvdataport(pipes_struct *p)
{
	...
	if(!spoolss_io_q_xcvdataport("", &q_u, data, 0)) {
		DEBUG0(("spoolss_io_q_replyopenprinter: unable to unmarshall SPOOL_Q_XCVDATAPORT.\n"));
		return False;
	}
	...
	if(!spoolss_io_r_xcvdataport("", &r_u, rdata, 0)) {
		DEBUG0(("spoolss_io_r_replyopenprinter: unable to marshall SPOOL_R_XCVDATAPORT.\n"));
		return False;
	}
