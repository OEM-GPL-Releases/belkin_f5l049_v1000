...
static BOOL api_lsa_open_policy2(pipes_struct *p)
{
	...
	if(!lsa_io_q_open_pol2("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_open_policy2: unable to unmarshall LSA_Q_OPEN_POL2.\n"));
		return False;
	}
	...
	if(!lsa_io_r_open_pol2("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_open_policy2: unable to marshall LSA_R_OPEN_POL2.\n"));
		return False;
	}
...
static BOOL api_lsa_open_policy(pipes_struct *p)
{
	...
	if(!lsa_io_q_open_pol("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_open_policy: unable to unmarshall LSA_Q_OPEN_POL.\n"));
		return False;
	}
	...
	if(!lsa_io_r_open_pol("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_open_policy: unable to marshall LSA_R_OPEN_POL.\n"));
		return False;
	}
...
static BOOL api_lsa_query_info(pipes_struct *p)
{
	...
	if(!lsa_io_q_query("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_query_info: failed to unmarshall LSA_Q_QUERY_INFO.\n"));
		return False;
	}
	...
	if(!lsa_io_r_query("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_query_info: failed to marshall LSA_R_QUERY_INFO.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_sids(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_sids("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_sids: failed to unmarshall LSA_Q_LOOKUP_SIDS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_sids("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_sids: Failed to marshall LSA_R_LOOKUP_SIDS.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_names(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_names("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_names: failed to unmarshall LSA_Q_LOOKUP_NAMES.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_names("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_names: Failed to marshall LSA_R_LOOKUP_NAMES.\n"));
		return False;
	}
...
static BOOL api_lsa_close(pipes_struct *p)
{
	...
	if (!lsa_io_q_close("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_close: lsa_io_q_close failed.\n"));
		return False;
	}
	...
	if (!lsa_io_r_close("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_close: lsa_io_r_close failed.\n"));
		return False;
	}
...
static BOOL api_lsa_open_secret(pipes_struct *p)
{
	...
	if(!lsa_io_q_open_secret("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_open_secret: failed to unmarshall LSA_Q_OPEN_SECRET.\n"));
		return False;
	}
	...
	if(!lsa_io_r_open_secret("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_open_secret: Failed to marshall LSA_R_OPEN_SECRET.\n"));
		return False;
	}
...
static BOOL api_lsa_enum_privs(pipes_struct *p)
{
	...
	if(!lsa_io_q_enum_privs("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_enum_privs: failed to unmarshall LSA_Q_ENUM_PRIVS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_enum_privs("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_enum_privs: Failed to marshall LSA_R_ENUM_PRIVS.\n"));
		return False;
	}
...
static BOOL api_lsa_priv_get_dispname(pipes_struct *p)
{
	...
	if(!lsa_io_q_priv_get_dispname("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_priv_get_dispname: failed to unmarshall LSA_Q_PRIV_GET_DISPNAME.\n"));
		return False;
	}
	...
	if(!lsa_io_r_priv_get_dispname("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_priv_get_dispname: Failed to marshall LSA_R_PRIV_GET_DISPNAME.\n"));
		return False;
	}
...
static BOOL api_lsa_enum_accounts(pipes_struct *p)
{
	...
	if(!lsa_io_q_enum_accounts("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_enum_accounts: failed to unmarshall LSA_Q_ENUM_ACCOUNTS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_enum_accounts("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_enum_accounts: Failed to marshall LSA_R_ENUM_ACCOUNTS.\n"));
		return False;
	}
...
static BOOL api_lsa_unk_get_connuser(pipes_struct *p)
{
	...
	if(!lsa_io_q_unk_get_connuser("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_unk_get_connuser: failed to unmarshall LSA_Q_UNK_GET_CONNUSER.\n"));
		return False;
	}
	...
	if(!lsa_io_r_unk_get_connuser("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_unk_get_connuser: Failed to marshall LSA_R_UNK_GET_CONNUSER.\n"));
		return False;
	}
...
static BOOL api_lsa_create_account(pipes_struct *p)
{
	...
	if(!lsa_io_q_create_account("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_create_account: failed to unmarshall LSA_Q_CREATEACCOUNT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_create_account("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_create_account: Failed to marshall LSA_R_CREATEACCOUNT.\n"));
		return False;
	}
...
static BOOL api_lsa_open_account(pipes_struct *p)
{
	...
	if(!lsa_io_q_open_account("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_open_account: failed to unmarshall LSA_Q_OPENACCOUNT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_open_account("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_open_account: Failed to marshall LSA_R_OPENACCOUNT.\n"));
		return False;
	}
...
static BOOL api_lsa_enum_privsaccount(pipes_struct *p)
{
	...
	if(!lsa_io_q_enum_privsaccount("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_enum_privsaccount: failed to unmarshall LSA_Q_ENUMPRIVSACCOUNT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_enum_privsaccount("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_enum_privsaccount: Failed to marshall LSA_R_ENUMPRIVSACCOUNT.\n"));
		return False;
	}
...
static BOOL api_lsa_getsystemaccount(pipes_struct *p)
{
	...
	if(!lsa_io_q_getsystemaccount("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_getsystemaccount: failed to unmarshall LSA_Q_GETSYSTEMACCOUNT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_getsystemaccount("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_getsystemaccount: Failed to marshall LSA_R_GETSYSTEMACCOUNT.\n"));
		return False;
	}
...
static BOOL api_lsa_setsystemaccount(pipes_struct *p)
{
	...
	if(!lsa_io_q_setsystemaccount("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_setsystemaccount: failed to unmarshall LSA_Q_SETSYSTEMACCOUNT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_setsystemaccount("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_setsystemaccount: Failed to marshall LSA_R_SETSYSTEMACCOUNT.\n"));
		return False;
	}
...
static BOOL api_lsa_addprivs(pipes_struct *p)
{
	...
	if(!lsa_io_q_addprivs("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_addprivs: failed to unmarshall LSA_Q_ADDPRIVS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_addprivs("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_addprivs: Failed to marshall LSA_R_ADDPRIVS.\n"));
		return False;
	}
...
static BOOL api_lsa_removeprivs(pipes_struct *p)
{
	...
	if(!lsa_io_q_removeprivs("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_removeprivs: failed to unmarshall LSA_Q_REMOVEPRIVS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_removeprivs("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_removeprivs: Failed to marshall LSA_R_REMOVEPRIVS.\n"));
		return False;
	}
...
static BOOL api_lsa_query_secobj(pipes_struct *p)
{
	...
	if(!lsa_io_q_query_sec_obj("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_query_secobj: failed to unmarshall LSA_Q_QUERY_SEC_OBJ.\n"));
		return False;
	}
	...
	if(!lsa_io_r_query_sec_obj("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_query_secobj: Failed to marshall LSA_R_QUERY_SEC_OBJ.\n"));
		return False;
	}
...
static BOOL api_lsa_add_acct_rights(pipes_struct *p)
{
	...
	if(!lsa_io_q_add_acct_rights("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_add_acct_rights: failed to unmarshall LSA_Q_ADD_ACCT_RIGHTS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_add_acct_rights("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_add_acct_rights: Failed to marshall LSA_R_ADD_ACCT_RIGHTS.\n"));
		return False;
	}
...
static BOOL api_lsa_remove_acct_rights(pipes_struct *p)
{
	...
	if(!lsa_io_q_remove_acct_rights("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_remove_acct_rights: failed to unmarshall LSA_Q_REMOVE_ACCT_RIGHTS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_remove_acct_rights("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_remove_acct_rights: Failed to marshall LSA_R_REMOVE_ACCT_RIGHTS.\n"));
		return False;
	}
...
static BOOL api_lsa_enum_acct_rights(pipes_struct *p)
{
	...
	if(!lsa_io_q_enum_acct_rights("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_enum_acct_rights: failed to unmarshall LSA_Q_ENUM_ACCT_RIGHTS.\n"));
		return False;
	}
	...
	if(!lsa_io_r_enum_acct_rights("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_enum_acct_rights: Failed to marshall LSA_R_ENUM_ACCT_RIGHTS.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_priv_value(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_priv_value("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_priv_value: failed to unmarshall LSA_Q_LOOKUP_PRIV_VALUE .\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_priv_value("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_priv_value: Failed to marshall LSA_R_LOOKUP_PRIV_VALUE.\n"));
		return False;
	}
...
static BOOL api_lsa_open_trust_dom(pipes_struct *p)
{
	...
	if(!lsa_io_q_open_trusted_domain("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_open_trust_dom: failed to unmarshall LSA_Q_OPEN_TRUSTED_DOMAIN .\n"));
		return False;
	}
	...
	if(!lsa_io_r_open_trusted_domain("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_open_trust_dom: Failed to marshall LSA_R_OPEN_TRUSTED_DOMAIN.\n"));
		return False;
	}
...
static BOOL api_lsa_create_trust_dom(pipes_struct *p)
{
	...
	if(!lsa_io_q_create_trusted_domain("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_create_trust_dom: failed to unmarshall LSA_Q_CREATE_TRUSTED_DOMAIN .\n"));
		return False;
	}
	...
	if(!lsa_io_r_create_trusted_domain("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_create_trust_dom: Failed to marshall LSA_R_CREATE_TRUSTED_DOMAIN.\n"));
		return False;
	}
...
static BOOL api_lsa_create_secret(pipes_struct *p)
{
	...
	if(!lsa_io_q_create_secret("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_create_secret: failed to unmarshall LSA_Q_CREATE_SECRET.\n"));
		return False;
	}
	...
	if(!lsa_io_r_create_secret("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_create_secret: Failed to marshall LSA_R_CREATE_SECRET.\n"));
		return False;
	}
...
static BOOL api_lsa_set_secret(pipes_struct *p)
{
	...
	if(!lsa_io_q_set_secret("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_set_secret: failed to unmarshall LSA_Q_SET_SECRET.\n"));
		return False;
	}
	...
	if(!lsa_io_r_set_secret("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_set_secret: Failed to marshall LSA_R_SET_SECRET.\n"));
		return False;
	}
...
static BOOL api_lsa_delete_object(pipes_struct *p)
{
	...
	if(!lsa_io_q_delete_object("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_delete_object: failed to unmarshall LSA_Q_DELETE_OBJECT.\n"));
		return False;
	}
	...
	if(!lsa_io_r_delete_object("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_delete_object: Failed to marshall LSA_R_DELETE_OBJECT.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_sids2(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_sids2("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_sids2: failed to unmarshall LSA_Q_LOOKUP_SIDS2.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_sids2("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_sids2: Failed to marshall LSA_R_LOOKUP_SIDS2.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_sids3(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_sids3("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_sids3: failed to unmarshall LSA_Q_LOOKUP_SIDS3.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_sids3("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_sids3: Failed to marshall LSA_R_LOOKUP_SIDS3.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_names2(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_names2("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_names2: failed to unmarshall LSA_Q_LOOKUP_NAMES2.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_names2("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_names2: Failed to marshall LSA_R_LOOKUP_NAMES2.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_names3(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_names3("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_names3: failed to unmarshall LSA_Q_LOOKUP_NAMES3.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_names3("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_names3: Failed to marshall LSA_R_LOOKUP_NAMES3.\n"));
		return False;
	}
...
static BOOL api_lsa_lookup_names4(pipes_struct *p)
{
	...
	if(!lsa_io_q_lookup_names4("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_lookup_names4: failed to unmarshall LSA_Q_LOOKUP_NAMES4.\n"));
		return False;
	}
	...
	if(!lsa_io_r_lookup_names4("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_lookup_names4: Failed to marshall LSA_R_LOOKUP_NAMES4.\n"));
		return False;
	}
...
static BOOL api_lsa_query_info2(pipes_struct *p)
{
	...
	if(!lsa_io_q_query_info2("", &q_u, data, 0)) {
		DEBUG0(("api_lsa_query_info2: failed to unmarshall LSA_Q_QUERY_INFO2.\n"));
		return False;
	}
	...
	if (!lsa_io_r_query_info2("", &r_u, rdata, 0)) {
		DEBUG0(("api_lsa_query_info2: failed to marshall LSA_R_QUERY_INFO2.\n"));
		return False;
	}
