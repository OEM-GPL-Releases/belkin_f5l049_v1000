				...
				const unsigned char mach_pw[16])
{
	...
	/* debug output */
	DEBUG5(("creds_init_128\n"));
	DEBUG5(("\tclnt_chal_in: %s\n", credstr(clnt_chal_in->data)));
	DEBUG5(("\tsrv_chal_in : %s\n", credstr(srv_chal_in->data)));
			...
			const unsigned char mach_pw[16])
{
	...
	/* debug output */
	DEBUG5(("creds_init_64\n"));
	DEBUG5(("\tclnt_chal_in: %s\n", credstr(clnt_chal_in->data)));
	DEBUG5(("\tsrv_chal_in : %s\n", credstr(srv_chal_in->data)));
	DEBUG5(("\tclnt+srv : %s\n", credstr(sum2)));
	DEBUG5(("\tsess_key_out : %s\n", credstr(dc->sess_key)));
...
{
	DEBUG10(("creds_server_init: neg_flags : %x\n", (unsigned int)neg_flags));
	DEBUG10(("creds_server_init: client chal : %s\n", credstr(clnt_chal->data) ));
	DEBUG10(("creds_server_init: server chal : %s\n", credstr(srv_chal->data) ));
	...
	DEBUG10(("creds_server_init: clnt : %s\n", credstr(dc->clnt_chal.data) ));
	DEBUG10(("creds_server_init: server : %s\n", credstr(dc->srv_chal.data) ));
	DEBUG10(("creds_server_init: seed : %s\n", credstr(dc->seed_chal.data) ));
...
BOOL creds_server_check(const struct dcinfo *dc, const DOM_CHAL *rcv_cli_chal_in)
{
	if (memcmp(dc->clnt_chal.data, rcv_cli_chal_in->data, 8)) {
		DEBUG5(("creds_server_check: challenge : %s\n", credstr(rcv_cli_chal_in->data)));
		DEBUG5(("calculated: %s\n", credstr(dc->clnt_chal.data)));
		DEBUG2(("creds_server_check: credentials check failed.\n"));
		return False;
	}
	DEBUG10(("creds_server_check: credentials check OK.\n"));
	return True;
}
			...
			DOM_CHAL *init_chal_out)
{
	...
	DEBUG10(("creds_client_init: neg_flags : %x\n", (unsigned int)neg_flags));
	DEBUG10(("creds_client_init: client chal : %s\n", credstr(clnt_chal->data) ));
	DEBUG10(("creds_client_init: server chal : %s\n", credstr(srv_chal->data) ));
	...
	DEBUG10(("creds_client_init: clnt : %s\n", credstr(dc->clnt_chal.data) ));
	DEBUG10(("creds_client_init: server : %s\n", credstr(dc->srv_chal.data) ));
	DEBUG10(("creds_client_init: seed : %s\n", credstr(dc->seed_chal.data) ));
...
BOOL creds_client_check(const struct dcinfo *dc, const DOM_CHAL *rcv_srv_chal_in)
{
	if (memcmp(dc->srv_chal.data, rcv_srv_chal_in->data, 8)) {
		DEBUG5(("creds_client_check: challenge : %s\n", credstr(rcv_srv_chal_in->data)));
		DEBUG5(("calculated: %s\n", credstr(dc->srv_chal.data)));
		DEBUG0(("creds_client_check: credentials check failed.\n"));
		return False;
	}
	DEBUG10(("creds_client_check: credentials check OK.\n"));
	return True;
}
