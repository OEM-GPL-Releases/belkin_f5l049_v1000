				 ...
				 POLICY_HND *domain_pol)
{
	...
	DEBUG10(("cli_samr_open_domain with sid %s\n", sid_string_static(domain_sid) ));
			       ...
			       uint32 user_rid, POLICY_HND *user_pol)
{
	...
	DEBUG10(("cli_samr_open_user with rid 0x%x\n", user_rid ));
				...
				uint32 group_rid, POLICY_HND *group_pol)
{
	...
	DEBUG10(("cli_samr_open_group with rid 0x%x\n", group_rid ));
				   ...
				   uint32 access_mask, POLICY_HND *group_pol)
{
	...
	DEBUG10(("cli_samr_create_dom_group\n"));
				    ...
				    SAM_USERINFO_CTR **ctr)
{
	...
	DEBUG10(("cli_samr_query_userinfo\n"));
				...
				POLICY_HND *group_pol, GROUP_INFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_set_groupinfo\n"));
                                  ...
                                  GROUP_INFO_CTR **ctr)
{
	...
	DEBUG10(("cli_samr_query_groupinfo\n"));
				      ...
				      DOM_GID **gid)
{
	...
	DEBUG10(("cli_samr_query_usergroups\n"));
				...
				POLICY_HND *alias_pol, ALIAS_INFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_set_aliasinfo\n"));
				       ...
				       uint32 *num_aliases, uint32 **als_rids)
{
	...
	DEBUG10(("cli_samr_query_useraliases\n"));
				    ...
				    uint32 **rid, uint32 **attr)
{
	...
	DEBUG10(("cli_samr_query_groupmem\n"));
                                 ...
                                 uint32 *num_dom_users)
{
	...
	DEBUG10(("cli_samr_enum_dom_users starting at index %u\n", (unsigned int)*start_idx));
	...
	*num_dom_users = r.num_entries2;
	...
	if (r.num_entries2) {
		...
		*rids = TALLOC_ARRAY(mem_ctx, uint32, r.num_entries2);
		if (!*rids) {
			DEBUG0( ("Error in cli_samr_enum_dom_users(): out of memory\n"));
			return NT_STATUS_NO_MEMORY;
		}
				     ...
				     uint32 *num_dom_groups)
{
	...
	DEBUG10(("cli_samr_enum_dom_groups starting at index %u\n", (unsigned int)*start_idx));
				     ...
				     uint32 *num_dom_aliases)
{
	...
	DEBUG10(("cli_samr_enum_als_groups starting at index %u\n", (unsigned int)*start_idx));
				    ...
				    DOM_SID **sids)
{
	...
	DEBUG10(("cli_samr_query_aliasmem\n"));
				...
				uint32 alias_rid, POLICY_HND *alias_pol)
{
	...
	DEBUG10(("cli_samr_open_alias with rid 0x%x\n", alias_rid));
				   ...
				   POLICY_HND *alias_pol)
{
	...
	DEBUG10(("cli_samr_create_dom_alias named %s\n", name));
				   ...
				   ALIAS_INFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_query_alias_info\n"));
				    ...
				    SAM_UNK_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_query_dom_info\n"));
				     ...
				     SAM_UNK_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_query_dom_info2\n"));
				     ...
				     SAM_UNK_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_set_domain_info\n"));
				    ...
				    const char *oldpassword )
{
	...
	DEBUG10(("rpccli_samr_chgpasswd_user\n"));
				    ...
				    DATA_BLOB old_lm_hash_enc)
{
	...
	DEBUG10(("rpccli_samr_chng_pswd_auth_crap\n"));
				...
				SAMR_CHANGE_REJECT *reject)
{
	...
	DEBUG10(("rpccli_samr_chgpasswd_user3\n"));
				    ...
				    SAM_DISPINFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_query_dispinfo for start_idx = %u\n", *start_idx));
				 ...
				 uint32 **name_types)
{
	...
	DEBUG10(("cli_samr_lookup_rids\n"));

        if (num_rids > 1000) {
                DEBUG2( ("cli_samr_lookup_rids: warning: NT4 can crash if "
                                  ...
                                  POLICY_HND *user_pol, uint32 *rid)
{
	...
	DEBUG10(("cli_samr_create_dom_user %s\n", acct_name));
                               ...
                               DATA_BLOB *sess_key, SAM_USERINFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_set_userinfo\n"));

	ZERO_STRUCT(q);
	ZERO_STRUCT(r);

	if (!sess_key->length) {
		DEBUG1( ("No user session key\n"));
                                ...
                                DATA_BLOB *sess_key, SAM_USERINFO_CTR *ctr)
{
	...
	DEBUG10(("cli_samr_set_userinfo2\n"));
                                  ...
                                  POLICY_HND *group_pol)
{
	...
	DEBUG10(("cli_samr_delete_dom_group\n"));
                                  ...
                                  POLICY_HND *alias_pol)
{
	...
	DEBUG10(("cli_samr_delete_dom_alias\n"));
                                  ...
                                  POLICY_HND *user_pol)
{
	...
	DEBUG10(("cli_samr_delete_dom_user\n"));
					    ...
					    DOM_SID *sid)
{
	...
	DEBUG10(("cli_samr_remove_sid_foreign_domain\n"));
                                 ...
                                 TALLOC_CTX *ctx, SEC_DESC_BUF **sec_desc_buf)
{
	...
	DEBUG10(("cli_samr_query_sec_obj\n"));
				 ...
				 uint16 *min_pwd_length, uint32 *password_properties)
{
	...
	DEBUG10(("cli_samr_get_dom_pwinfo\n"));
				       ...
				       uint32 *password_properties, uint32 *unknown1)
{
	...
	DEBUG10(("cli_samr_get_usrdom_pwinfo\n"));
				...
				DOM_SID *sid)
{
	...
	DEBUG10(("cli_samr_lookup_domain\n"));
