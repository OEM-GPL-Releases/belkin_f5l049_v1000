...
/* FIX No-381: Chenge by silex technology for AP Scan */
#define IW_SCAN_MAX_DATA	(4096*4)	/* In bytes */  /*!< silex */
/*! Normary IW_SCAN_MAX_DATA is 4096 bytes.
 *   But , some AP has infomation over 800bytes.
 *   ( e.g.: BUUFALO WZR-AMPG300NH )
 *   This case, 5 units can search. However, up to 6 units can not search.
 *   ( 4096 / 800 = 5 )
 *   Generally, stay in one unit of WZR-AMPG300NH, when up to 9 units can not search.
 */
